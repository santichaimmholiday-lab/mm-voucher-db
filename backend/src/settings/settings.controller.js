...
var SettingsController = function () {
    var _classDecorators = [(0, common_1.Controller)('api/settings')];
    ...
    var SettingsController = _classThis = /** @class */ (function () {
        ...
        SettingsController_1.prototype.getSettings = function () {
            return this.settingsService.getSettings();
        };
        SettingsController_1.prototype.updateSettings = function (data) {
            return this.settingsService.updateSettings(data);
        };
        SettingsController_1.prototype.uploadFile = function (file) {
            return __awaiter(this, void 0, void 0, function () {
                var fileName, _a, data, error, publicUrlData;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (!file)
                                throw new Error('No file uploaded');
                            fileName = "".concat(Date.now(), "-").concat(Math.round(Math.random() * 1e9), "-").concat(file.originalname.replace(/[^a-zA-Z0-9.]/g, ''));
                        ...
                        case 1:
                            ...
                            publicUrlData = this.supabase.storage
                                .from('uploads')
    ...
    (function () {
        ...
        _updateSettings_decorators = [(0, common_1.Put)()];
