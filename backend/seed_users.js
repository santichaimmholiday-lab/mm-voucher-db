...
function seedUsers() {
    return __awaiter(this, void 0, void 0, function () {
        var app, prisma, users, _i, users_1, u, existing, hashedPassword;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    u = users_1[_i];
                    return [4 /*yield*/, prisma.tb_user.findUnique({ where: { username: u.username } })];
                case 3:
                    existing = _a.sent();
                ...
                case 4:
                    ...
                    return [4 /*yield*/, prisma.tb_user.create({
                            data: {
                                username: u.username,
                                email: u.email,
                                role: u.role,
                ...
                case 5:
                    _a.sent();
                    console.log("Created user: ".concat(u.username));
                    return [3 /*break*/, 7];
                case 6:
                    console.log("User already exists: ".concat(u.username));
                    _a.label = 7;
                case 7:
                    _i++;
                    return [3 /*break*/, 2];
