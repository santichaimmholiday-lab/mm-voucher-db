            ...
            <div className="font-mali text-gray-700 text-sm">
              {voucher.voucher_type === 'HOTEL' && (
                <div className="grid grid-cols-2 gap-y-1 gap-x-4">
                  ...
                  <div className="flex flex-col"><span className="text-[10px] text-gray-400 uppercase font-sans font-bold leading-none mt-1">Breakfast</span> <span className="text-purple-900 font-bold leading-tight">{voucher.breakfast || '-'}</span></div>
              ...
              {(voucher.voucher_type === 'TOUR' || voucher.voucher_type === 'SHARING TOUR') && (
                <div className="grid grid-cols-2 gap-y-1 gap-x-4">
                  ...
                  <div className="flex flex-col"><span className="text-[10px] text-gray-400 uppercase font-sans font-bold leading-none mt-1">Date of Visit</span> <span className="text-purple-900 font-bold leading-tight">{voucher.visit_date ? format(new Date(voucher.visit_date), 'dd/MM/yyyy') : '-'}</span></div>
